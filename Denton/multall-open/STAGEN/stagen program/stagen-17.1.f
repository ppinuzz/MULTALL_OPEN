...
C   SET THE DEFAULT INTEGERS
      ...
      IF_CUSP = 0   ! DO NOT GENERATE A CUSP
      ICUSP  = 0    ! SURFACE WITH WHICH ANY CUSP IS ALIGNED
      LCUSP  = 4    ! NUMBER OF CELLS ON THE CUSP
...
C   SET THE GAS PROPERTIES
      CP      = 1005. ! SPECIFIC HEAT CAPACITY FOIR AIR
...
C   FOR ALL THE VISCOUS MODELS
      ...
      TURBVIS_LIM  = 1000.0 ! LIMIT ON TURBULENT VISCOSITY/ LAMINAR VISCOSITY
...
C
C     IF ILOS = 10
      FRACPB  = 0.03        !  MIXING LENGTH LIMIT ON THE BLADE SURFACES
      FRACPW  = 0.03        !  MIXING LENGTH LIMIT DOWNSTREAM OF THE BLADES
      FRACPUP = 0.02        !  MIXING LENGTH LIMIT UPSTREAM OF THE LEADING EDGE
C     IF ILOS = 100
...
C
      ...
      IF(KTIPS.NE.0.AND.KTIPE.NE.0) THEN
...
C
      WRITE(10,*)   ' IF_CUSP   IFANGLES '
      WRITE(10,1703)  IF_CUSP,  IFANGLES
      IF(IF_CUSP.EQ.1) WRITE(10,1703)   ICUSP, LCUSP, LCUSPUP
      IF(IF_CUSP.EQ.2) WRITE(10,1714  ) 2, 2, 3, 0.01, 0.99
C
C********************************************************************************
C********************************************************************************
C 
