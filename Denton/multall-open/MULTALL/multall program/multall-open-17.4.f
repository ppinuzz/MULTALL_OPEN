...
C   OF THE  PARAMETER STATEMENTS IN "commall-open-17.4"                C
C                                                                      C
...
C
      IF(ROUGH.GT.1.0E-7) THEN
           TWI1    = CF*ROAVG1*WAVG*WAVG/128
C
C          VSTAR   = SQRT(TWI1/ROAVG1/4)  
C      Changed by WS/LX  17 May, 2017 
           VSTAR   = SQRT(TWI1/(0.25*ROAVG1))
C
           PLUSK   = ROUGH*VSTAR*ROAVG1/VISLAM/4
           RELOG10 = LOG10(DPERP/ROUGH)
           FUNCN   = 5.75*RELOG10 + 8.5
...
C
      IF(ROUGH.GT.1.0E-7) THEN
           TWIM     = CF*ROAVGIM*WAVG*WAVG/128
C
C          VSTAR   = SQRT(TWIM/ROAVGIM/4)  
C      Changed by WS/LX  17 May, 2017  
           VSTAR   = SQRT(TWIM/(0.25*ROAVGIM))
C
           PLUSK   = ROUGH*VSTAR*ROAVGIM/VISLAM/4
           RELOG10 = LOG10(DPERP/ROUGH)
           FUNCN   = 5.75*RELOG10 + 8.5
...
C
      IF(ROUGH.GT.1.0E-7) THEN
           TW1     = CF*ROAVG1*WAVG*WAVG/128
C
C		   VSTAR   = SQRT(TW1/ROAVG1/4)  
C      Changed by WS/LX  17 May, 2017  
           VSTAR   = SQRT(TW1/(0.25*ROAVG1))
C
           PLUSK   = ROUGH*VSTAR*ROAVG1/VISLAM/4
           RELOG10 = LOG10(DPERP/ROUGH)
           FUNCN   = 5.75*RELOG10 + 8.5
...
C
      IF(ROUGH.GT.1.0E-7) THEN
           TWKM    = CF*ROAVGKM*WAVG*WAVG/128
C
C		   VSTAR   = SQRT(TWKM/ROAVGKM/4)  
C      Changed by WS/LX  17 May, 2017  
           VSTAR   = SQRT(TWKM/(0.25*ROAVGKM))
C
           PLUSK   = ROUGH*VSTAR*ROAVGKM/VISLAM/4
           RELOG10 = LOG10(DPERP/ROUGH)
           FUNCN   = 5.75*RELOG10 + 8.5
